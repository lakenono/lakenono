...
@Slf4j
public class oldBaiduZhidaoListTaskProducer extends PagingFetchTaskProducer
{
	...
	public oldBaiduZhidaoListTaskProducer(String name, String keyword, String dateType) throws UnsupportedEncodingException
	{
	...
	public static void main(String[] args) throws Exception
	{
		...
		{
			log.info("{} start!", k);
			oldBaiduZhidaoListTaskProducer producer = new oldBaiduZhidaoListTaskProducer(name, k, dateType);
			producer.run();
			log.info("{} finish!", k);
		}
	}
